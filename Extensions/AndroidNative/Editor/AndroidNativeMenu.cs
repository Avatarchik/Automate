...
public class AndroidNativeMenu : EditorWindow {
	...
	[MenuItem("Window/Android Native/Documentation/Notes/Version 4.8")]
	public static void NotesVersion4_8() {
		string url = "https://unionassets.com/android-native-plugin/version-4-8-41";
		Application.OpenURL(url);
	}
